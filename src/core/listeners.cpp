...
DEFINE_MANAGER_ACCESSOR(OnClientVoice, void, int)
...
DEFINE_MANAGER_ACCESSOR(OnEntityCreated, void, CEntityInstance*)
DEFINE_MANAGER_ACCESSOR(OnEntityDeleted, void, CEntityInstance*)
