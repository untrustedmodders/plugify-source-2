...
static_assert(__builtin_offsetof(trace_t_s2, startpos) == 120);
static_assert(__builtin_offsetof(trace_t_s2, endpos) == 132);
static_assert(__builtin_offsetof(trace_t_s2, startsolid) == 183);
static_assert(__builtin_offsetof(trace_t_s2, fraction) == 172);
