...
extern "C" PLUGIN_API void GetMapName(plg::string& result)
{
...
extern "C" PLUGIN_API void IsModelPrecache(const plg::string& model)
{
...
extern "C" PLUGIN_API void EmitSound(int entityIndex, const plg::string& sound, int pitch, float volume, float delay)
{
